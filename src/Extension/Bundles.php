...
class Bundles extends Extension
{
    ...
    protected function doClassProcess()
    {
        ...
        $this->definitions['document_bundle']->setDocComment(
            <<<EOF
            /**
...
EOF
        ...
        if (!$this->configClass['isEmbedded']) {
            ...
            $this->definitions['repository_bundle']->setParentClass(
                '\\' . $this->definitions['repository_base']->getClass()
            );
            $this->definitions['repository_bundle']->setDocComment(
                <<<EOF
                /**
...
EOF
            ...
            $this->definitions['query_bundle']->setDocComment(
                <<<EOF
                /**
